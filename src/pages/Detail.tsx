          ...
          <div className="lg:px-20 px-10 md:pt-5 pt-32 mb-20 font-Poppins">
            <div className="flex-col md:grid md:grid-cols-2  gap-2 justify-center items-center mt-5 md:mt-10">
              <div className="h-full w-full">
                <img loading="lazy" srcSet={data?.image} className="w-full md:h-[80vh] h-[40vh] mt-5" />
              </div>
              <div className="grid  md:grid-cols-2 grid-cols-4 gap-3 justify-center items-center mt-5 md:h-[80vh] h-[10vh] w-full  md:w-[40vw]">
                <img loading="lazy" srcSet={data?.dataImage.image1} className="w-full md:rounded-none rounded-md h-full" />
                <img loading="lazy" srcSet={data?.dataImage.image2} className="w-full md:rounded-none rounded-md h-full" />
                <img loading="lazy" srcSet={data?.dataImage.image3} className="w-full md:rounded-none rounded-md h-full" />
                <img loading="lazy" srcSet={data?.dataImage.image4} className="w-full md:rounded-none rounded-md h-full" />
              </div>
            </div>
          </div>
          <div className="md:px-20 px-5 md:flex flex-col font-Poppins">
            ...
            <div className="flex-col md:flex-row my-3 gap-8 justify-center items-start">
              <div className="flex-col md:flex-row w-full">
                <p className=" font-light text-justify md:tracking-wide leading-7 text-sm ">
                  <span className="font-semibold">{data?.title}</span> was Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem lorem aliquam sed lacinia quis. Nibh dictumst vulputate odio pellentesque sit quis ac, sit ipsum. Sit
                  rhoncus velit in sed massa arcu sit eu. Vitae et vitae eget lorem non dui. Sollicitudin ut mi adipiscing duis. Convallis in semper laoreet nibh leo. Vivamus malesuada ipsum pulvinar non rutrum risus dui, risus. Purus massa
                  velit iaculis tincidunt tortor, risus, scelerisque risus. In at lorem pellentesque orci aenean dictum dignissim in. Aenean pulvinar diam interdum ullamcorper. Vel urna, tortor, massa metus purus metus. Maecenas mollis in
                  velit auctor cursus scelerisque eget.
                </p>
