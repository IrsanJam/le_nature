  ...
  return (
    <div className="flex flex-col pt-2.5 bg-white my-20">
      <div className="flex gap-5 justify-center items-center relative">
        ...
        <span className="absolute right-0 justify-center self-start px-20 py-3.5 mt-2.5 text-sm leading-5 text-cyan-500 rounded bg-black bg-opacity-0 max-md:pr-5">See all</span>
      </div>
      <div className="md:mt-14 mt-7 relative">
        ...
        />
        <div className="flex absolute top-1 right-20 gap-4 justify-center px-5 py-3.5 mt-96 mr-16 rounded bg-zinc-900 max-md:mt-10 max-md:mr-2.5">
